...
| 02-01-02 | 01 | 1 | MISS-01, MISS-03 | T-02-04 | Mission/AssignedMission and touched Phase 1 analog entities use Lombok boilerplate safely, avoid broad setters, and expose family-scoped repository contracts consumed by later plans | compile | `cd backend && ./mvnw -DskipTests compile` | ❌ W0 | ⬜ pending |
